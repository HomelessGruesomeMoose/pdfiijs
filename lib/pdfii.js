...
function pdfii(filename) {
  ...
  this.getPagesCount = function(cb, callback) {
  ...
  this.getPages = function(filename, pages_count, cb, callback) {
    var pages = {};
  ...
  this.getIndexes = function(pages, pages_count, callback) {
    var indexes = [];
    for (var page = 1; page <= pages_count; page++) {
  ...
  this.mergeIndexes = function(indexes, callback) {
    var merged = {};
